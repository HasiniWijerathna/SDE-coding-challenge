...
import { loginURL } from '../../services/urlFactoryService/urlFactory';
...
class Login extends BaseContainer {
  ...
  */
  onChangePassword = (changeEvent) => {
    ...
    const passwordError = Login.validatePassword(password).passwordError;
  ...
  */
  static validatePassword(password = '') {
    let passwordError = null
     passwordError = loginPasswordValidator(password)
  ...
  */
  validateAll = () => {
      return !this.state.errorMessage.password && 
              ...
              <div className="form-card-content">
                ...
                <div className="card-primary-button">
                  <LoginButton
                    ...
                    disabled={!this.state.formValid}>Login</LoginButton>
                </div>
              </div>
            </div>
          </CardContent>
          <CardActions>
            <div className="form-card-actions-container">
              <div className="card-secondary-button">
                <Button size="small" onClick={this.signUp}>Don't have an account? Sign up</Button>
              </div>
            </div>
          </CardActions>
        </Card>
